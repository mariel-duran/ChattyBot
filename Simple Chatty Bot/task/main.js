...
function test() {
	...
	console.log("What are loops?")
	console.log("1. A way to interrupt the execution of a program.")
	console.log("2. A way to execute the same code as long as specific conditions are met.")
	while (true) {
